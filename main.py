...
from ms2binner.visualization import plot_ms2_components, plot_ms2_components_fine
import argparse
...
if __name__ == "__main__":
        ...
        parser.add_argument('-pl', '--plot', action='store_true', help='plots a visualization of the spectra')
        parser.add_argument('-plf', '--fineplot', action='store_true', help='plots a detailed visualization of the spectra')
        ...
        if args.fineplot:
                plot_ms2_components_fine(data, bins, num_components=args.components, output_file=args.image, headless=args.headless)